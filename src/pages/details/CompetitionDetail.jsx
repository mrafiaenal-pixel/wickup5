...
const competitionDetailsData = {
  ...
  "cerdas-cermat": {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Peserta adalah siswa aktif SMP sederajat tahun ajaran 2026/2027.",
          "Perwakilan tim (minimal satu orang) WAJIB hadir saat Technical Meeting.",
      ...
      },
      {
        ...
        items: [
          ...
          "Selama kegiatan berlangsung di seluruh babak perlombaan (Penyisihan, Semifinal, maupun Final), peserta dilarang menggunakan alat bantu hitung/elektronik apa pun (termasuk kalkulator, HP, dan jam tangan).",
      ...
      },
      {
        ...
        items: [
          "Penonton dilarang memberikan isyarat/jawaban kepada peserta. Jika melanggar, tim diberi nilai 0 pada soal tersebut, dan pemotongan -25 poin setelah 1 kali peringatan.",
        ],
      },
      {
        code: "H",
        ...
        items: [
          "Peserta wajib mengenakan seragam batik sekolah / almamater resmi. Toleransi keterlambatan maksimal 5 menit dari jadwal (lebih dari itu dianggap WO).",
        ],
      },
      {
        code: "I",
        ...
        items: [
          "Jika terjadi gangguan teknis (bel rusak, listrik padam, sistem error), soal yang terdampak akan diulang atau dihentikan sementara dengan batas waktu penanganan maksimal 15 menit.",
        ],
      },
      {
        code: "J",
        ...
        items: [
          "Protes dilakukan tertulis oleh guru pendamping maksimal 15 menit setelah pertandingan berakhir.",
          "Kecurangan / alat elektronik berakibat diskualifikasi langsung.",
        ],
      },
      {
        code: "K",
    ...
    lampiran: [
      { title: "Surat Undangan Resmi (SMP)", url: "/0766 Undangan Wikrama Cup V 2026.pdf" },
      { title: "Regulasi Cerdas Cermat", url: "/Regulasi Cerdas Cermat.pdf" },
